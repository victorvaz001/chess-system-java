...
public class ChessMatch {
	...
	private void validateTargetPosition(Position source, Position target) {
		/*se pra peça de origem, 
		a posição de destino não e 
		um movimento possivel, então 
		não posso mecher essa peça pra la  */
	...
	private boolean testeCheck(Color color) {
		Position kingPosition = king(color).getChessPosition().toPosition(); /*pegando a posição do Rei no formato de Matriz*/
